            ...
            (o.prototype.init = function () {
              ...
              utils.on(e.core.el, "onAfterSlide.lgtm", function (t) {
                window.location.hash =
                  "lg=" + e.core.s.galleryId + "&slide=" + t.detail.index;
              }),
                utils.on(window, "hashchange.lghash", function () {
                  t = window.location.hash;
                  var o = parseInt(t.split("&slide=")[1], 10);
                  t.indexOf("lg=" + e.core.s.galleryId) > -1
                    ? e.core.slide(o, !1, !1)
                    : e.core.lGalleryOn && e.core.destroy();
                });
            }),
              (o.prototype.destroy = function () {
                this.core.s.hash &&
            ...
            (r.prototype.init = function () {
              ...
              if (
                ...
                for (var i = 0; i < e.core.items.length; i++)
                  t += e.core.s.exThumbImage
                    ? '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                      e.core.items[i].getAttribute(e.core.s.exThumbImage) +
                      '" /></div></span>'
                    : '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                      e.core.items[i].querySelector("img").getAttribute("src") +
                      '" /></div></span>';
              ...
              for (var a = 0; a < r.length; a++)
                !(function (t) {
                  utils.on(r[t], "click.lg touchend.lg", function () {
                    (e.core.index = t), e.core.slide(e.core.index, !1, !1);
                  });
                })(a);
              utils.on(n, "mouseover.lg", function () {
                clearTimeout(o), utils.addClass(n, "lg-pager-hover");
              }),
                ...
                utils.on(e.core.el, "onBeforeSlide.lgtm", function (e) {
                  for (var t = 0; t < r.length; t++)
                    utils.removeClass(r[t], "lg-pager-active"),
                      e.detail.index === t &&
                        utils.addClass(r[t], "lg-pager-active");
                });
            }),
            ...
            (i.prototype.init = function () {
              ...
              (i.prototype.build = function () {
                ...
                if (
                  ...
                  (e.thumbOuter =
                    e.core.outer.querySelector(".lg-thumb-outer")),
                ...
                for (var h = 0; h < u.length; h++)
                  !(function (t) {
                    ...
                    if (o) {
                      window["lgJsonP" + e.el.getAttribute("lg-uid") + h] =
                        function (t) {
                  ...
                  if (utils.hasClass(i, "lg-has-video")) {
                    ...
                    e.core.s.dynamic
                      ...
                      : ((a =
                        ...
                        (d =
                          e.core.items[e.core.index].getAttribute("data-html")),
                        c(a, d));
          ...
          !(function (t, o) {
            ...
            (r.prototype.init = function () {
              ...
              (r.prototype.touchendZoom = function (e, t, o, r) {
                var l = this,
                  i =
                    l.core.___slide[l.core.index].querySelector(".lg-img-wrap"),
