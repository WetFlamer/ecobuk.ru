__do__loader__([61], {
    131: function(e, t, n) {
        var o, l;
        void 0 === (l = "function" === typeof (o = function() {
            "use strict";
            return function(e, t) {
                var n, o, l, r, i, s, a, u, c, p, d, m, f, h, w, v, g, _, b = this, C = !1, T = !0, I = !0, E = {
                    barsSize: {
                        top: 44,
                        bottom: "auto"
                    },
                    ...
                    if (v)
                        return !0;
                    e = e || window.event,
                    w.timeToIdle && w.mouseUsed && !c && M();
                    for (var n, o, l = (e.target || e.srcElement).getAttribute("class") || "", r = 0; r < P.length; r++)
                        (n = P[r]).onTap && l.indexOf("pswp__" + n.name) > -1 && (n.onTap(),
                        o = !0);
                    if (o) {
                    ...
                    e !== h && (x(o, "ui--one-slide", e),
                    h = e)
                }, k = function() {
                    x(a, "share-modal--hidden", I)
                }, K = function() {
                    return (I = !I) ? (t.removeClass(a, "pswp__share-modal--fade-in"),
                    setTimeout(function() {
                        I && k()
                    }, 300)) : (k(),
                    setTimeout(function() {
                    ...
                    for (var e, t, n, o, l = "", r = 0; r < w.shareButtons.length; r++)
                        ...
                        l += '<a href="' + e.url.replace("{{url}}", encodeURIComponent(n)).replace("{{image_url}}", encodeURIComponent(t)).replace("{{raw_image_url}}", t).replace("{{text}}", encodeURIComponent(o)) + '" target="_blank" class="pswp__share--' + e.id + '"' + (e.download ? "download" : "") + ">" + e.label + "</a>",
                ...
                b.init = function() {
                    ...
                    p("onPinchClose", function(e) {
                        T && e < .9 ? (b.hideControls(),
                        i = !0) : i && !T && e > .9 && b.showControls()
                    }),
                    p("zoomGestureEnded", function() {
                        (i = !1) && !T && b.showControls()
                    }),
                    ...
                    p("beforeChange", function() {
                        ...
                        f = setTimeout(function() {
                            e.currItem && e.currItem.loading ? (!e.allowProgressiveImg() || e.currItem.img && !e.currItem.img.naturalWidth) && A(!1) : A(!0)
                ...
                ,
                b.update = function() {
                    T && e.currItem ? (b.updateIndexIndicator(),
                ...
                b.onGlobalTap = function(n) {
                    ...
                    if (!v)
                        ...
                        } else if (w.tapToToggleControls && (T ? b.hideControls() : b.showControls()),
