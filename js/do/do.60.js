            ...
            return function(e, t, n, i) {
                var o = {
                    ...
                    detectFeatures: function() {
                        ...
                        for (var s, u, c = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"], m = 0; m < 4; m++) {
                            t = d[m];
                            for (var p = 0; p < 3; p++)
                                s = c[p],
                ...
                o.extend(r, i);
                var l, s, u, c, d, m, p, f, h, y, x, v, g, w, b, I, C, D, T, M, S, A, E, O, k, R, Z, P, F, L, _, z, N, U, H, Y, W, B, G, X, V, K, q, $, j, J, Q, ee, te, ne, ie, oe, ae, re, le, se, ue = {
                    x: 0,
                    y: 0
                }, ce = {
                    x: 0,
                    ...
                    x: 0,
                    y: 0
                }, ye = 0, xe = !0, ve = [], ge = {}, we = !1, be = function(e, t) {
                    ...
                    te && (e && (y > a.currItem.fitRatio ? we || ($t(a.currItem, !1, !0),
                    we = !0) : we && ($t(a.currItem),
                    we = !1)),
                    Ae(te, de.x, de.y, y))
                }, Oe = function(e) {
                    ...
                    Le && (o.unbind(document, "mousemove", _e),
                    ...
                    e && (K || V || ne || W) && (e.preventDefault(),
                    e.stopPropagation())
                }, Be = function() {
                    a.setScrollOffset(0, o.getScrollY())
                }, Ge = {}, Xe = 0, Ve = function(e) {
                    Ge[e] && (Ge[e].raf && R(Ge[e].raf),
                    Xe--,
                    delete Ge[e])
                }, Ke = function(e) {
                    Ge[e] && Ve(e),
                    ...
                    init: function() {
                        if (!l && !s) {
                            ...
                            for (_.animationName && _.transform && !i || (r.showAnimationDuration = r.hideAnimationDuration = 0),
                            n = 0; n < ve.length; n++)
                                a["init" + ve[n]]();
                            ...
                            r.modal && (xe ? e.style.position = "fixed" : (e.style.position = "absolute",
                            e.style.top = o.getScrollY() + "px")),
                            void 0 === L && (Te("initialLayout"),
                            L = P = o.getScrollY());
                            var u = "pswp--open ";
                ...
                }, Je = {}, Qe = {}, et = {}, tt = {}, nt = {}, it = [], ot = {}, at = [], rt = {}, lt = 0, st = {
                    x: 0,
                    y: 0
                }, ut = 0, ct = {
                    x: 0,
                    ...
                    return xt.prevent = !yt(e.target, r.isClickableElement),
                    ...
                    it.forEach(function(e) {
                        ...
                        se++
                    })) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Dt[0] = gt(e.touches[0], It),
                    e.touches.length > 1 && (Dt[1] = gt(e.touches[1], Ct))) : (It.x = e.pageX,
                    It.y = e.pageY,
                    It.id = "",
                    Dt[0] = It),
                    Dt
                }, Mt = function(e, t) {
                    var n, i, o, l, s = de[e] + t[e], u = t[e] > 0, c = ct.x + t.x, d = ct.x - ot.x;
                    if (n = s > ee.min[e] || s < ee.max[e] ? r.panEndFriction : 1,
                    s = de[e] + t[e] * n,
                    (r.allowPanToNext || y === a.currItem.initialZoomLevel) && (te ? "h" !== ie || "x" !== e || V || (u ? (s > ee.min[e] && (n = r.panEndFriction,
                    ee.min[e],
                    i = ee.min[e] - ce[e]),
                    (i <= 0 || d < 0) && Ht() > 1 ? (l = c,
                    d < 0 && c > ot.x && (l = ot.x)) : ee.min.x !== ee.max.x && (o = s)) : (s < ee.max[e] && (n = r.panEndFriction,
                    ee.max[e],
                    i = ce[e] - ee.max[e]),
                    (i <= 0 || d > 0) && Ht() > 1 ? (l = c,
                    d > 0 && c < ot.x && (l = ot.x)) : ee.min.x !== ee.max.x && (o = s))) : l = c,
                    "x" === e))
                    ...
                    var i, l = Tt(e), s = l.length;
                    if ("mouseup" === e.type && (s = 0),
                    2 === s)
                        return j = null,
                        !0;
                    1 === s && Pe(nt, l[0]),
                    0 !== s || ie || ne || (t || ("mouseup" === e.type ? t = {
                        x: e.pageX,
                        y: e.pageY,
                        type: "mouse"
                    ...
                    var e, t, n = {
                        ...
                        calculateSwipeSpeed: function(i) {
                            at.length > 1 ? (e = Me() - U + 50,
                            t = at[at.length - 2][i]) : (e = Me() - N,
                            t = nt[i]),
                        ...
                        calculateOverBoundsAnimOffset: function(e, t) {
                            ...
                            $e("bounceZoomPan" + e, de[e], n.backAnimDestination[e], t || 300, o.easing.sine.out, function(t) {
                                de[e] = t,
                                Ee()
                            }))))
                        },
                    ...
                    i && ((c += i) < 0 ? (c = r.loop ? Ht() - 1 : 0,
                    l = !0) : c >= Ht() && (c = r.loop ? 0 : Ht() - 1,
                    l = !0),
                    l && !r.loop || (ye += i,
                    pe -= i,
                    n = !0));
                    var d, m = he.x * pe, p = Math.abs(m - ct.x);
                    return n || m > ct.x === t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? p / Math.abs(t.lastFlickSpeed.x) : 333,
                    d = Math.min(d, 400),
                ...
                be("Gestures", {
                    publicMethods: {
                        initGestures: function() {
                            ...
                            E ? navigator.msPointerEnabled ? e("MSPointer", "Down", "Move", "Up", "Cancel") : e("pointer", "down", "move", "up", "cancel") : _.touch ? (e("touch", "start", "move", "end", "cancel"),
                ...
                var Lt, _t, zt, Nt, Ut, Ht, Yt = function(t, n, i, l) {
                    var s;
                    Lt && clearTimeout(Lt),
                    Nt = !0,
                    zt = !0,
                    ...
                    var d, m, p = i ? r.hideAnimationDuration : r.showAnimationDuration, f = function() {
                        Ve("initialZoom"),
                    ...
                    if (!p || !s || void 0 === s.x)
                        return Te("initialZoom" + (i ? "Out" : "In")),
                        ...
                        i) {
                            var n = s.w / t.w
                              ...
                              , u = function(t) {
                                1 === t ? (y = n,
                                de.x = s.x,
                                de.y = s.y - L) : (y = (n - r) * t + r,
                                de.x = (s.x - a.x) * t + a.x,
                                de.y = (s.y - L - a.y) * t + a.y),
                                Ee(),
                                m ? e.style.opacity = 1 - t : Se(l - t * l)
                            };
                            d ? $e("initialZoom", 0, 1, p, o.easing.cubic.out, u, f) : (u(1),
                    ...
                    if (e.src && !e.loadError) {
                        ...
                        return function(e, t, n) {
                            ...
                            i.max.y = n > Wt.y ? Math.round(Wt.y - n) + e.vGap.top : i.center.y,
                    ...
                    if (Bt.length) {
                        for (var e, t = 0; t < Bt.length; t++)
                            (e = Bt[t]).holder.index === e.index && Vt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
                        Bt = []
                    }
                };
                be("Controller", {
                    publicMethods: {
                        lazyLoadItem: function(e) {
                            e = Ie(e);
                            var t = Ut(e);
                            t && (!t.loaded && !t.loading || b) && (Te("gettingData", e, t),
                            t.src && Kt(t))
                        },
                        initController: function() {
                            ...
                            De("beforeChange", function(e) {
                                var t, n = r.preload, i = null === e || e >= 0, o = Math.min(n[0], Ht()), l = Math.min(n[1], Ht());
                                for (t = 1; t <= (i ? l : o); t++)
                                    a.lazyLoadItem(c + t);
                                for (t = 1; t <= (i ? o : l); t++)
                                    a.lazyLoadItem(c - t)
                        ...
                        setContent: function(e, t) {
                            ...
                            if (s) {
                                ...
                                !s.src || s.loadError || s.loaded)
                                    ...
                                    if (s.loadComplete = function(n) {
                                        if (l) {
                                            if (e && e.index === t) {
                                                ...
                                                n.placeholder = null) : _.transform && (ne || Nt) ? Bt.push({
                                                    item: n,
                                                    baseDiv: u,
                                                    img: n.img,
                                                    index: t,
                                    ...
                                    s.loading || Kt(s),
                                    a.allowProgressiveImg() && (!zt && _.transform ? Bt.push({
                                        item: s,
                                        baseDiv: u,
                                        img: s.img,
                                        index: t,
                    ...
                    publicMethods: {
                        ...
                        handleMouseWheel: function(e) {
                            if (y <= a.currItem.fitRatio)
                                return r.modal && (!r.closeOnScroll || Xe || G ? e.preventDefault() : A && Math.abs(e.deltaY) > 2 && (u = !0,
                                a.close())),
                                !0;
                ...
                var nn, on, an, rn, ln, sn, un, cn, dn, mn, pn, fn, hn = {
                    history: !0,
                    galleryUID: 1
                }, yn = function() {
                    ...
                    Xe || G)
                        ...
                        fn ? "#" + n !== window.location.hash && history[cn ? "replaceState" : "pushState"]("", document.title, i) : cn ? pn.replace(i) : pn.hash = n,
                        cn = !0,
                    ...
                    publicMethods: {
                        initHistory: function() {
                            ...
                            r.history) {
                                ...
                                var e = function() {
                                    sn = !0,
                                    dn || (mn ? history.back() : un ? pn.hash = un : fn ? history.pushState("", document.title, pn.pathname + pn.search) : pn.hash = ""),
                                    xn()
                                };
                                De("unbindEvents", function() {
                                    u && e()
