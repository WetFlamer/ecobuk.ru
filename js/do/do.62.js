    ...
    !(function (t, n) {
      ...
      function Ie(e, t, n, r) {
        ...
        if (
          ...
          for (s = (a = C.map(ye(i, "script"), Pe)).length; f < p; f++)
            (u = i),
              f !== d &&
                ((u = C.clone(u, !0, !0)), s && C.merge(a, ye(u, "script"))),
              n.call(e[f], u, f);
          if (s)
            for (
      ...
      function We(e, t, n) {
        for (var r, i = t ? C.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
          n || 1 !== r.nodeType || C.cleanData(ye(r)),
            r.parentNode &&
              (n && C.contains(r.ownerDocument, r) && ve(ye(r, "script")),
            ...
            return (
              ...
              i ||
                ...
                (c &&
                  ...
                  ((u = r[c]) && (r[c] = null),
                  (C.event.triggered = y),
                  e.isPropagationStopped() && d.addEventListener(y, bt),
                  r[y](),
                  e.isPropagationStopped() && d.removeEventListener(y, bt),
